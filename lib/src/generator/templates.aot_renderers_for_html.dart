...
String renderLibrary(LibraryTemplateData context0) {
  ...
  if (context11.hasPublicExtensions == true) {
    ...
    for (var context14 in context13) {
      buffer.write('\n        ');
      buffer.write(_renderCategory_partial_extension_5(context14));
    }
    buffer.writeln();
    buffer.write('''
      </dl>
  ...
  if (context19.hasPublicConstants == true) {
    ...
    for (var context22 in context21) {
      buffer.write('\n        ');
      buffer.write(_renderCategory_partial_constant_6(context22));
    }
    buffer.writeln();
    buffer.write('''
      </dl>
  ...
  if (context23.hasPublicProperties == true) {
    ...
    for (var context26 in context25) {
      buffer.write('\n        ');
      buffer.write(_renderCategory_partial_property_7(context26));
    }
    buffer.writeln();
    buffer.write('''
      </dl>
  ...
  if (context27.hasPublicFunctions == true) {
    ...
    for (var context30 in context29) {
      buffer.write('\n        ');
      buffer.write(_renderCategory_partial_callable_8(context30));
    }
    buffer.writeln();
    buffer.write('''
      </dl>
  ...
  if (context31.hasPublicEnums == true) {
    ...
    for (var context34 in context33) {
      buffer.write('\n        ');
      buffer.write(_renderCategory_partial_container_3(context34));
    }
    buffer.writeln();
    buffer.write('''
      </dl>
...
String renderIndex(PackageTemplateData context0) {
  ...
  for (var context3 in context2) {
    ...
    for (var context8 in context7) {
      ...
      for (var context10 in context9) {
        buffer.write('\n            ');
        buffer.write(_renderCategory_partial_library_2(context10));
      }
    }
    buffer.writeln();
    buffer.write('''
...
String _deduplicated_lib_templates_html__static_methods_html(
  ...
  <section class="summary offset-anchor" id="static-methods">
    ...
    for (var context2 in context1) {
      buffer.write('\n        ');
      buffer.write(__renderClass_partial_instance_methods_11_partial_callable_0(
          context2));
    }
    buffer.writeln();
    buffer.write('''
